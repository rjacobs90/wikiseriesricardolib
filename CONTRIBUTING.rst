...
Ready to contribute? Here's how to set up `wikiseriesricardolib` for local development.
Using of pipenv is highly recommended.

1. Clone your fork locally::

    $ git clone https://github.com/rjacobs90/wikiseriesricardolib
